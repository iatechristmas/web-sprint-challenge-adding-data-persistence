...
SQL is the language used to communicate with a database, whereas a Relational Database is a group of items that have pre-defined relationships between them, organized with tables, columns and rows.

2. Why do tables need a `primary key`?

Tables need primary keys so columns can be uniquely defined. No two rows can have the same key.
...
Create a third table, otherwise known as a join table.
